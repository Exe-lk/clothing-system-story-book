        ...
        <div className={`${styles.right} col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-12`} >
          ...
          <div className="row mx-0 bg-white mb-3">
            ...
            <div className="col-12 d-flex align-items-center">
              <PiCircleDashedBold className='me-3 fs-3 fw-bold' color='rgb(108, 93, 211,1)'/>
              <p className='fs-5 fs-sm-5 fs-md-4 fs-lg-4 fs-xl-4 fs-xxl-4 fw-bold'>Variable defaults</p>
            </div>
            <div className="col-12 ">
              <p className='fs-xxl-6 fs-xl-6 fs-lg-6 fs-md-6 fs-sm-7 fs-7'>
                Every Sass variable in Bootstrap includes the !default flag allowing you to override the variable’s default value in your own Sass without modifying Bootstrap’s source code. Copy and paste variables as needed, modify their values, and remove the !default flag. If a variable has already been assigned, then it won’t be re-assigned by the default values in Bootstrap.

                You will find the complete list of Bootstrap’s variables in the list below. Some variables are set to null, these variables don’t output the property unless they are overridden in your configuration.
              </p>
            </div>

            <div className="col-12 d-flex align-items-center">
              <p className='alert w-100 fs-xxl-6 fs-xl-6 fs-lg-6 fs-md-6 fs-sm-7 fs-7'style={{background:'#dbe1fe'}} ><IoMdInformationCircleOutline className='fs-4 me-2 '/>We have overwritten some variables of the bootstrap and added new variables. Variables Used: <code>src/styles/settings/_index.scss</code>to update used variables.</p>
            </div>
