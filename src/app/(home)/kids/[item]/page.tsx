...
const KidsItem = () => {
  ...
  const [items, setItems] = useState<Item []>(kidsRelatedItemsList);
              ...
              <div className='row mx-1 mx-sm-1 mx-md-1 mx-lg-0 mx-xl-0 mx-xxl-0 my-3' >
                <nav aria-label="breadcrumb" className=' my-auto'>
                  <ol className="breadcrumb fs-7 fs-sm-6 fs-md-5 fs-xxl-5 fs-xl-5 fs-lg-5">
                    ...
                    <li className="breadcrumb-item"><a href="/kids" className='text-decoration-none' style={{color: 'rgba(0, 0, 0, 0.35)'}}>{`mens`}</a></li>
                ...
                <div className={`${styles.itemDetails} col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 p-1`} >
                  ...
                  <div className='mx-0 my-1 p-2 ' >
                    <div className="col-12">
                      <Link href={`/kids/${item.itemId}&${item.name}/pay`} className='btn text-capitalize text-white fw-bold fs-7 fs-sm-6 fs-md-5 fs-lg-6 fs-xl-5 fs-xxl-5 m-0 p-1 w-50' style={{background:'rgba(171, 93, 2, 1)'}}>
                        pay now
                      </Link>
                    </div>
                  </div>
