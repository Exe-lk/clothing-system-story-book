...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className={`${styles.header} col-6 col-sm-6 col-md-6 col-xxl-4 col-xl-4 col-lg-3 d-flex align-items-center justify-content-center text-center mt-3`}>
        <p className="h1 text-uppercase fs-1 p-o m-0" >fashion<span ><b>nova</b></span></p>
      </div>
      <div className='col-xxl-3 col-xl-4 col-lg-4 col-md-3 col-sm-3 col-3 d-flex align-items-center justify-content-xxl-end justify-content-xl-end justify-content-lg-end justify-content-sm-center justify-content-md-center justify-content-end mt-4'>
